...
const NAV_ITEMS = [
  { href: '/ceolab', label: 'Home', icon: HomeIcon },
  { href: '/ceolab/results', label: 'Results', icon: ResultsIcon },
  { href: '/ceolab/settings', label: 'Settings', icon: SettingsIcon },
]
      ...
      <nav className="hidden md:block fixed top-0 left-0 right-0 z-50 bg-white border-b border-black/5">
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            {navItems.map((item) => {
              const isActive = item.href === '/ceolab'
                ? pathname === '/ceolab'

...
import { getBenchmarkContext, DIMENSION_BENCHMARKS } from '@/lib/benchmarks'
...
function CoachingSection({ dimensionScores }: { dimensionScores: DimensionScore[] }) {
  ...
  return (
    <div className="bg-white rounded-lg p-6 md:p-8 shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
...
// ---------------------------------------------------------------------------
// Complete Results View (wrapper with data loading)
// ---------------------------------------------------------------------------
